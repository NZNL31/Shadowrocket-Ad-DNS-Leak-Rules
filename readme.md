...
### 修改说明
基于 Shadowrocket-ADBlock-Rules-Forever 项目，结合 colin-chang 设计的 a-nomad.conf 进行个人优化。原版 a-nomad.conf 以防 DNS 泄露为目的，引用了 ACL4SSR 的分流规则。**所有规则都会在每天北京时间 10:00 自动更新。**
